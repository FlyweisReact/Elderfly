...
const Staff = () => {
  ...
  const AddStaff = async (e) => {
    e.preventDefault()
    try{
      const { data } = await axios.post("https://sqd1nkfeu1.execute-api.ap-south-1.amazonaws.com/development/api/v1/staff" , {
        name , address , birthday , gender ,officialEmail , nationality , 
        language , 
        phoneNumber , Department , workLocation , emailAddress , 
        ...
        <div className="dash-right">
          ...
          <div className="staff-top-cont">
            ...
            <div className="staff-top-cont-r">
              ...
              <a href="#some">
              <button onClick={() => setAddStaff(!addStaff)}>Setup Details</button>
              </a>
