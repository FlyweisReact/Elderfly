...
const Subs = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const AddSubscription = async (e) => {
        e.preventDefault()
        try{
            const { HandlerData } = await axios.post("https://sqd1nkfeu1.execute-api.ap-south-1.amazonaws.com/development/api/v1/subcriptions" , {
                planName , amountPerMonth , data , endDate , startDate
            })
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
        {
            successMessage ? <Alert variant="success"> Subscription Added   </Alert> : ""
        }
          <Form onSubmit={AddSubscription}>
            <Form.Group className="mb-3">
              <Form.Label>Plan Name</Form.Label>
              <Form.Control type="text" onChange={(e) => setPlanName(e.target)} />
            </Form.Group>
            <Form.Group className="mb-3">
