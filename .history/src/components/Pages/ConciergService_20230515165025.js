    ...
    const fetchData = async () => {
      try {
        const { data } = await axios.get(
            "https://sqd1nkfeu1.execute-api.ap-south-1.amazonaws.com/development/api/v1/conciergeServicess"
        );
        setData(data);
      } catch (e) {
        console.log(e);
    ...
    const deleteHandler = async (id) => {
      try {
        const { data } = await axios.delete(
            `https://sqd1nkfeu1.execute-api.ap-south-1.amazonaws.com/development/api/v1/conciergeServicess/${id}`
            );
        console.log(data);
