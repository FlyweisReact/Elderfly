  ...
  function MyVerticallyCenteredModal(props) {
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          {successMessage ? (
            <Alert variant="success"> Subscription Added </Alert>
          ) : (
            ""
          )}
          <Form onSubmit={AddSubscription}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="number" min={0}  onChange={(e) => setPlanName(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="date"  onChange={(e) => setPlanName(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
